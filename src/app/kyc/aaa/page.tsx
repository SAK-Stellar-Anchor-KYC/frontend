...
import { KycFormAaa } from '@/components/KycFormAaa';
import { useWallet } from '@/hooks/useWallet';
import { useKyc } from '@/hooks/useKyc';

export const dynamic = 'force-dynamic';

export default function KycAaaPage() {
  ...
  const existingKyc = getKycByType('aaa');

  return (
    <Layout>
      <div className="space-y-6">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-dark-text mb-2">AAA KYC</h1>
          <p className="text-dark-textMuted">Highest level identity verification</p>
        </div>
        ...
        {existingKyc?.status === 'validated' ? (
          <div className="max-w-2xl mx-auto bg-dark-card border border-crypto-success rounded-lg p-8 text-center">
            ...
            <p className="text-dark-textMuted mb-6">
              Your AAA KYC has been successfully validated
            </p>
            <button
